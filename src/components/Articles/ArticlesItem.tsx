...
const ArticlesItem = ({
  ...
  return (
    <div className="mt-5 border border-solid border-[#e5e5e5] rounded-lg overflow-hidden transition-all duration-200 group hover:-translate-y-1 hover:shadow-[0_6px_20px_rgba(168,172,185,0.3)]">
      <div className="">
        <img className="" src={img} alt="عکس مقاله" />
      </div>
      <div className="pt-5 px-4">
        <Link
          className="hover:text-primary text-[#464749] text-sm font-vazirMedium"
          to="articles/1"
        >
          {title}
        </Link>
