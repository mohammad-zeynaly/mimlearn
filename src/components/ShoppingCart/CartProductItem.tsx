...
const CartProductItem = ({ title, img, price, count }: CoursesType) => {
  return (
    <li className="flex items-center h-24 border-b w-full">
      <span className="bg-[rgba(0,0,0,.08)] text-[#9ca4ac] font-vazirBold h-full w-5 flex items-center justify-center transition-all hover:bg-red-500 hover:text-white">
        x
      </span>
